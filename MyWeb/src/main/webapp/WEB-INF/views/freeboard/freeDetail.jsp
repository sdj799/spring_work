...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form action= "<c:url value='/freeboard/modify'/>"method="post" >
                            ...
                            <div class="form-group">
                                <label>작성자</label>
                                <input class="form-control" name="writer" readonly value="${article.writer}">
                            </div>    
                            <div class="form-group">
                                <label>제목</label>
                                <input class="form-control" name='title' readonly value="${article.title}">
                            </div>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            getList(1, true); //게시글 상세보기 화면에 처음 진입했을시 댓글 리스트를 한 번 불러오자.
            ...
            보장이 없기 때무넹 해당 방식은 이벤트 등록이 불가능합니다.
